...
create index if not exists idx_recetas_especificas_materiales_receta_id on public.recetas_especificas_materiales(receta_id);
...
drop policy if exists "recetas_especificas_materiales_update" on public.recetas_especificas_materiales;
